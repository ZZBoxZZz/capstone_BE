...
function initModels(sequelize) {
  ...
  hinh_anh.belongsToMany(hinh_anh, { as: 'hinh_id_hinh_anhs', through: luu_anh, foreignKey: "nguoi_dung_id", otherKey: "hinh_id" });
  hinh_anh.belongsToMany(hinh_anh, { as: 'nguoi_dung_id_hinh_anhs', through: luu_anh, foreignKey: "hinh_id", otherKey: "nguoi_dung_id" });
  binh_luan.belongsTo(hinh_anh, { as: "nguoi_dung", foreignKey: "nguoi_dung_id"});
  hinh_anh.hasMany(binh_luan, { as: "binh_luans", foreignKey: "nguoi_dung_id"});
  luu_anh.belongsTo(hinh_anh, { as: "nguoi_dung", foreignKey: "nguoi_dung_id"});
  hinh_anh.hasMany(luu_anh, { as: "luu_anhs", foreignKey: "nguoi_dung_id"});
  luu_anh.belongsTo(hinh_anh, { as: "hinh", foreignKey: "hinh_id"});
  hinh_anh.hasMany(luu_anh, { as: "hinh_luu_anhs", foreignKey: "hinh_id"});
